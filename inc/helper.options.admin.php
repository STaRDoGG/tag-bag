...
return array(
	...
	'administration' => array(
		...
		array('datatxt_id', __('dataTXT API ID', 'tagbag'), 'text', 'regular-text',
			__('You can create an API ID from <a href="https://dandelion.eu">here</a>', 'tagbag')),
		...
		array('datatxt_min_confidence', __('dataTXT API min_confidence (default: 0.6)', 'tagbag'), 'text', 'regular-text',
	...
	'auto-links' => array(
		...
		array('auto_link_max_by_post', __('Maximum number of links per article:', 'tagbag'), 'number', 'small-text',
			__('This setting determines the maximum number of links created by article. Default: 10.', 'tagbag')),
		array('auto_link_max_by_tag', __('Maximum number of links for the same tag:', 'tagbag'), 'number', 'small-text',
			__('This setting determines the maximum number of links created by article for the same tag. Default: 1.', 'tagbag')),
	...
	'tagcloud' => array(
		array('text_helper', 'text_helper', 'helper', '', __('What\'s difference between <strong>&#8216;Order tags selection&#8217;</strong> and <strong>&#8216;Order tags display&#8217;</strong>?<br />', 'tagbag')
			...
			__('<strong>Example:</strong> You want display randomly the 100 tags most popular.<br />', 'tagbag').
		...
		array('cloud_limit_qty', __('Maximum number of tags to display: (default: 45)', 'tagbag'), 'number', 'small-text'),
	...
	'relatedposts' => array(
		...
		array('rp_xformat', __('Post link format:', 'tagbag'), 'text', 'widefat',
			__('You can find markers and explanations <a href="https://github.com/herewithme/simple-tags/wiki/Theme-functions-Integration">in the online documentation.</a>', 'tagbag')),
		array('rp_limit_qty', __('Maximum number of related posts to display: (default: 5)', 'tagbag'), 'text', 'regular-text'),
