<?php
/**
 * Tag Bag widget class
 */
class tagbag_Widget extends WP_Widget {
	/**
	 * Constructor widget
	 *
	 * @return void
	...
	public function __construct() {
		parent::__construct( 'tagbag', __( 'Tag Cloud (Tag Bag)', 'tagbag' ),
			array( 'classname' => 'widget-tagbag', 'description' => __( 'Your most used tags in cloud format with dynamic color and many options', 'tagbag' ) )
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		tb_tag_cloud( apply_filters( 'tag-bag-widget', 'title='.$param, $instance ) ); // Use Widgets title and no TB title!
	...
	public function form( $instance ) {
		...
		?>
		<p><?php _e('Empty field will use default value.', 'tagbag'); ?></p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('max'); ?>">
				<?php _e('Max tags to display: (Default: 45)', 'tagbag'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('selectionby'); ?>">
				<?php _e('Order by for DB selection tags:', 'tagbag'); ?>
				<select id="<?php echo $this->get_field_id('selectionby'); ?>" name="<?php echo $this->get_field_name('selectionby'); ?>">
					<option <?php selected( $instance['selectionby'], 'name' ); ?> value="name"><?php _e('Name', 'tagbag'); ?></option>
					<option <?php selected( $instance['selectionby'], 'slug' ); ?> value="slug"><?php _e('Slug', 'tagbag'); ?></option>
					<option <?php selected( $instance['selectionby'], 'term_group' ); ?> value="term_group"><?php _e('Term group', 'tagbag'); ?></option>
					<option <?php selected( $instance['selectionby'], 'count' ); ?> value="count"><?php _e('Counter (default)', 'tagbag'); ?></option>
					<option <?php selected( $instance['selectionby'], 'random' ); ?> value="random"><?php _e('Random', 'tagbag'); ?></option>
				</select>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('selection'); ?>">
				<?php _e('Order for DB selection tags:', 'tagbag'); ?>
				<select id="<?php echo $this->get_field_id('selection'); ?>" name="<?php echo $this->get_field_name('selection'); ?>">
					<option <?php selected( $instance['selection'], 'asc' ); ?> value="asc"><?php _e('ASC', 'tagbag'); ?></option>
					<option <?php selected( $instance['selection'], 'desc' ); ?> value="desc"><?php _e('DESC (default)', 'tagbag'); ?></option>
				</select>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('orderby'); ?>">
				<?php _e('Order by for display tags:', 'tagbag'); ?>
				<select id="<?php echo $this->get_field_id('orderby'); ?>" name="<?php echo $this->get_field_name('orderby'); ?>">
					<option <?php selected( $instance['orderby'], 'name' ); ?> value="name"><?php _e('Name', 'tagbag'); ?></option>
					<option <?php selected( $instance['orderby'], 'count' ); ?> value="count"><?php _e('Counter', 'tagbag'); ?></option>
					<option <?php selected( $instance['orderby'], 'random' ); ?> value="random"><?php _e('Random (default)', 'tagbag'); ?></option>
				</select>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('order'); ?>">
				<?php _e('Order for display tags:', 'tagbag'); ?>
				<select id="<?php echo $this->get_field_id('order'); ?>" name="<?php echo $this->get_field_name('order'); ?>">
					<option <?php selected( $instance['order'], 'asc' ); ?> value="asc"><?php _e('ASC', 'tagbag'); ?></option>
					<option <?php selected( $instance['order'], 'desc' ); ?> value="desc"><?php _e('DESC (default)', 'tagbag'); ?></option>
				</select>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('smini'); ?>">
				<?php _e('Font size min: (Default: 8)', 'tagbag'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('smax'); ?>">
				<?php _e('Font size max: (Default: 22)', 'tagbag'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('unit'); ?>">
				<?php _e('Unit font size:', 'tagbag'); ?>
				<select id="<?php echo $this->get_field_id('unit'); ?>" name="<?php echo $this->get_field_name('unit'); ?>">
					<option <?php selected( $instance['unit'], 'pt' ); ?> value="pt"><?php _e('Point (default)', 'tagbag'); ?></option>
					<option <?php selected( $instance['unit'], 'px' ); ?> value="px"><?php _e('Pixel', 'tagbag'); ?></option>
					<option <?php selected( $instance['unit'], 'em' ); ?> value="em"><?php _e('Em', 'tagbag'); ?></option>
					<option <?php selected( $instance['unit'], '%'  ); ?> value="%"><?php _e('Pourcent', 'tagbag'); ?></option>
				</select>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('format'); ?>">
				<?php _e('Format:', 'tagbag'); ?>
				<select id="<?php echo $this->get_field_id('format'); ?>" name="<?php echo $this->get_field_name('format'); ?>">
					<option <?php selected( $instance['format'], 'flat' ); ?> value="flat"><?php _e('Flat (default)', 'tagbag'); ?></option>
					<option <?php selected( $instance['format'], 'list' ); ?> value="list"><?php _e('List (UL/LI)', 'tagbag'); ?></option>
				</select>
			</label>
		</p>
		...
		<p>
			<label for="<?php echo $this->get_field_id('color'); ?>">
				...
				<?php _e('Use auto color cloud:', 'tagbag'); ?>
			</label>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id('cmini'); ?>">
				<?php _e('Font color min: (Default: #CCCCCC)', 'tagbag'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('cmax'); ?>">
				<?php _e('Font color max: (Default: #000000)', 'tagbag'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('xformat'); ?>">
				<?php _e('Tag Link Format:', 'tagbag'); ?><br />
		...
		<p>
			<label for="<?php echo $this->get_field_id('adv_usage'); ?>">
				<?php _e('Advanced Usage:', 'tagbag'); ?><br />
