...
class tagbag_Client {
	...
	public function __construct() {
		...
		if ( (int) tagbag_Plugin::get_option_value('use_tag_pages') == 1 ) {
			add_action( 'init', array(__CLASS__, 'init'), 11 );
			add_action( 'parse_query', array(__CLASS__, 'parse_query') );
		}

		// Call autolinks ?
		if ( (int) tagbag_Plugin::get_option_value('auto_link_tags') == 1 ) {
			require( TAGB_DIR . '/inc/class.client.autolinks.php');
			new tagbag_Client_Autolinks();
		}

		// Call related posts ?
		if ( (int) tagbag_Plugin::get_option_value('active_related_posts') ==  1 ) {
			require( TAGB_DIR . '/inc/class.client.related_posts.php');
			new tagbag_Client_RelatedPosts();
		}

		// Call auto terms ?
		require( TAGB_DIR . '/inc/class.client.autoterms.php');
		new tagbag_Client_Autoterms();

		// Call post tags ?
		require( TAGB_DIR . '/inc/class.client.post_tags.php');
		new tagbag_Client_PostTags();
	...
	public static function init_translation() {
		// Load translations
		load_plugin_textdomain('tagbag', false, basename(TAGB_DIR) . '/languages');
	}
	...
	public static function output_content( $html_class= '', $format = 'list', $title = '', $content = '', $copyright = true, $separator = '' ) {
		...
		if ( $copyright === true )
			return "\n" . '<!-- Generated by Tag Bag ' . TAGB_VERSION . ' - https://github.com/STaRDoGG/tag-bag -->' ."\n\t". $title . $output. "\n";
		else
			return "\n\t". $title . $output. "\n";
	}
